...
insert into user (id, type, account_id, name, email, mobile, phone, password, marketing_agreement, subscription_id, created_time,
                  modified_time)
values (1, 'personal', 'test01personal', '테스트용 개인 사용자', 'test@personal.com', '01012345678', '05312345678', '{bcrypt}$2a$10$NC5hlrD/BhjMXZtE2ZH.8.Hanx4WLggyOy4I1sY9ZhSE5i8qXXFPO',
        true, null, '2023-10-13 09:00:00', '2023-10-13 09:00:00'),
